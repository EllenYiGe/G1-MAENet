...
DTU_CKPT_FILE=$DTU_LOG_DIR"/model.ckpt"
DTU_OUT_DIR="./outputs/dtu/"$exp

python -m torch.distributed.launch train_mae.py --logdir $DTU_LOG_DIR --dataset=dtu_yao4 --batch_size=2 --trainpath=$DTU_TRAINING --summary_freq 100 \
